(function(undefined) {
  ...
  sigma.prototype.toGEXF = function(params) {
    ...
    for (var i = 0; i < nodes.length; i++) {
      ...
      // NODE LABEL
      if (o.label) nodeElem.setAttribute("label", o.label);

      // NODE ATTRIBUTES
      attrs = strToObjectRef(o, null); // paramas.nodeAttributes
      if (attrs) {
        ...
        if (o.color) {
          ...
          if (rgb.length > 2) {
            ...
            if (rgb.length > 3) {
              ...
              else colorElem.setAttribute("a", rgb[3]);
            }
    ...
    for (var i = 0; i < edges.length; i++) {
      ...
      // EDGE LABEL
      if (o.label) edgeElem.setAttribute("label", o.label);

      // EDGE ATTRIBUTES
      attrs = strToObjectRef(o, null); //params.edgeAttributes
      if (attrs) {
        attrsElem = doc.createElement("attvalues");
      ...
      if (params.renderer) {
        if (o.color) {
          ...
          if (rgb.length > 2 && rgb.length <= 5) {
            // ignore alpha in rgba
            colorElem = doc.createElement("viz:color");
            colorElem.setAttribute("r", rgb[0]);
            colorElem.setAttribute("g", rgb[1]);
            colorElem.setAttribute("b", rgb[2]);
